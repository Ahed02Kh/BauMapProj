    ...
    if($power == 'yes'){
       ...
       if ($deluser != 1) {
        ...
        $alertMessage = "<div class='alert alert-danger'> 
            ...
            $alertMessage = "<div class='alert alert-danger'> 
            <p>Please Tasneem cannot Delete yourself <strong>THANK YOU.</strong> </p><br>       
            <a type='button' class='btn btn-default btn-sm' data-dismiss='alert'>Cancel</a> 
            </div>";
        }        
    }else{
			...
			<div class="container clearfix">
				...
				<nav>
					<ul>
						...
						<li><a href="../../index.html"><i class="icon-book3"></i>Courses</a></li>
    ...
    <?php
        ...
        if(mysqli_num_rows($result) > 0){
         ...
         while( $row = mysqli_fetch_assoc($result) ){
                echo "<tr>";
                    echo "<td>".$row["id"]."</td>
                    <td><img src=images/admin/".$row["profilePic"]." width='80px' height='80px'> </td>
                    <td>".$row["name"]."</td>
